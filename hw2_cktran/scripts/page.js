...
$(document).ready( function() {
  ...
  setTimeout(function() {
      ...
      player_avatar = $('#player_avatar');  // set the global player handle
      ...
      $(window).keyup(function() {
        setTimeout(function() {
            document.getElementById("player_avatar").src = 'img/person.png';
        }, 1200);
      });
...
function movePerson(arrow) {
  ...
  switch (arrow) {
    case KEYS.left: { // left arrow
      //document.getElementById("player_avatar").src = "img/player_left.gif";
    ...
    case KEYS.right: { // right arrow
      //document.getElementById("player_avatar").src = 'img/player_right.gif';
      let newPos = parseInt(player.css('left'))+PERSON_SPEED;
    ...
    case KEYS.up: { // up arrow
      //document.getElementById("player_avatar").src = 'img/player_up.gif';
      let newPos = parseInt(player.css('top'))-PERSON_SPEED;

      if (newPos < 0) {
            newPos = 0;
      }
      else if (isOrWillCollide(player, paradeFloat1, 0, -PERSON_SPEED) || isOrWillCollide(player, paradeFloat2, 0, -PERSON_SPEED)) {
    ...
    case KEYS.down: { // down arrow
      //document.getElementById("player_avatar").src = 'img/player_down.gif';
      let newPos = parseInt(player.css('top'))+PERSON_SPEED;
...
function updateThrownItemPosition(elementObj, xChange, yChange, iterationsLeft){
    ...
    if (iterationsLeft <= 0) {
        ...
        setTimeout(function() { updateThrownItemPosition(elementObj, xChange, yChange, iterationsLeft-1); }, 50);
    }
}
